        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {programs.map((program, i) => (
            <Link
              ...
              className="group relative overflow-hidden rounded-2xl border border-primary/10 bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1 sm:p-8"
